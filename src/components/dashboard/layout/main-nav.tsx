  ...
  return (
    <React.Fragment>
      ...
      {isNotifDetailsOpen && (
        <div
          ref={notifRef}
          className="flex flex-col fixed w-fit right-4 self-end top-24 bg-[#081635] border border-gray-600 rounded-lg shadow-lg z-[99999]"
        >
          ...
          <div className="border-t border-gray-600">
            <Link
              href="/dashboard/anomaly-notification"
              passHref
              onClick={() => setIsNotifDetailsOpen(false)}
            >

              <button className="w-full text-[#E6EDF5] py-3 hover:bg-gray-800">
                View All Anomaly
              </button>
            </Link>
          </div>
