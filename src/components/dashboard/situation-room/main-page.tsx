...
import DatePickerComponent from '@/components/dashboard/overview/button/date-picker';
...
const MainPageSituationRoom = () => {
    ...
    const handleOptionSelection = (option: string) => {
        ...
        // Perform any action you need when an option is selected
        console.log('Selected option:', option);
        // Example: Trigger a function like fetching data based on the selected option
        // fetchData(option);
    };
...
export default MainPageSituationRoom
