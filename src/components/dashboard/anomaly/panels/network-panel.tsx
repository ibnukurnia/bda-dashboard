...
interface TabNetworkContentProps {
...
const TabNetworkContent: React.FC<TabNetworkContentProps> = ({
    selectedNetwork,
}) => {
    ...
    const fetchDataByPagination = async (
        ...
        try {
            ...
            const result = await GetHistoricalLogAnomalies(selectedNetwork, limit, page, filter, selectedServicesOptions, startTimeValue, endTimeValue);
    ...
    const loadAnomalyFilterOptions = async () => {
        try {
            const response = await fetchAnomalyOption(selectedNetwork); // Pass the correct utilization type to the API call
    ...
    const loadServicesFilterOptions = async () => {
        try {
            const response = await fetchServicesOption(selectedNetwork)
            // console.log('API Response:', response) // Log the entire API response
    ...
    }, [autoRefresh, refreshInterval, selectedNetwork, pagination.pageIndex, pagination.pageSize, selectedAnomalyOptions, selectedServicesOptions, startTime, endTime]);
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className='flex flex-col gap-2'>
                            <Typography variant="h5" component="h5" color="white">
                                {`Historical ${selectedNetwork} Anomaly Records`}
                            </Typography>
                                        ...
                                        <div className="flex gap-1">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    handlePageSizeChange(newPageSize, selectedNetwork, 1, selectedAnomalyOptions);
                                                }}
...
export default TabNetworkContent
